                                ...
                                twoItems: {
                                    startItem: {
                                        firstValue: {
                                            fields: [
                                                {
                                                    fieldPath: `object.textModulesData['${GoogleWallet_FrontFieldPaths.PRIMARY_LEFT.toLowerCase()}']`
                                                }
                                            ]
                                        }
                                    },
                                    endItem: {
                                        firstValue: {
                                            fields: [
                                                {
                                                    fieldPath: `object.textModulesData['${GoogleWallet_FrontFieldPaths.PRIMARY_RIGHT.toLowerCase()}']`
                                                }
                                            ]
                                        }
                                    }
                                ...
                                twoItems: {
                                    startItem: {
                                        firstValue: {
                                            fields: [
                                                {
                                                    fieldPath: `object.textModulesData['${GoogleWallet_FrontFieldPaths.SECONDARY_LEFT.toLowerCase()}']`
                                                }
                                            ]
                                        }
                                    },
                                    endItem: {
                                        firstValue: {
                                            fields: [
                                                {
                                                    fieldPath: `object.textModulesData['${GoogleWallet_FrontFieldPaths.SECONDARY_RIGHT.toLowerCase()}']`
                                                }
                                            ]
                                        }
                                    }
